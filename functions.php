...
function vvt_scripts() {
    ...
    wp_enqueue_style( 'google-font-archivo', $scheme . 'fonts.googleapis.com/css?family=Droid+Sans');
    wp_enqueue_style( 'google-font-archivo', $scheme . 'fonts.googleapis.com/css?family=Courgette');
